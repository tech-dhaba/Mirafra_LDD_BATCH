#include <linux/module.h> // used for module_init(),module_exit(), module_LICENSE(); macros
#include <linux/kernel.h>// used for printk()
#include <linux/fs.h>// File operations like read(),write()
#include <linux/uaccess.h> // For copy_to_user() and copy_from_user() functionalities
