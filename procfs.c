...
//After loading into kernel the .ko file ,dmesg,my_proc_file is created.it is a virtual proc file created by proc_create function.managed by the kernel module.
//in /proc directory my_proc_file is there after loading the module.this will communicate with the user.
