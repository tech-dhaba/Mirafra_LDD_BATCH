/*   file gpio_driver practice */
/* file name gpio_driver3.c    */
...
#define GPIO_PIN 525  // Pin number on Raspberry Pi GPIO
...
static int gpio_open(struct inode *inode, struct file *file) {
    pr_info("GPIO Device opened, it can perform the opeaations \n");
    return 0;
}

static int gpio_close(struct inode *inode, struct file *file) {
    pr_info("GPIO Device closed, bye bye\n");
    return 0;
}
