...
#define LED 529  // Replace with the GPIO pin number you want to use
...
static irqreturn_t gpio_irq_handler(int irq, void *dev_id) {
   ...
   led_state = !led_state;
   gpiod_set_value(gpiod,led_state);
    gpio_set_value(LED, led_state);  // Use the GPIO descriptor to set value
